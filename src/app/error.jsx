...
const ErrorPage = () => {
  return (
    <div className="mt-24 px-4 flex items-center justify-center min-h-[60vh]">
      <div className="max-w-md w-full text-center shadow-sm dark:border border-foreground/15 rounded-xl p-8 bg-background dark:bg-foreground/5">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/"
            className=" active:scale-95 px-4 py-2 rounded-lg bg-foreground/10 hover:bg-foreground/15 duration-100"
          >
            Go Home
          </Link>
        </div>
