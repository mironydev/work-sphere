    ...
    <div className="rounded-lg border-t-2 dark:border border-white dark:border-foreground/10 bg-white/80 dark:bg-foreground/5 shadow-[0_1px_2px_rgba(0,0,0,0.06)]">
      ...
      <Form onSubmit={onSubmit} className="p-6 space-y-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button
            type="button"
            className="bg-red-50 dark:bg-red-600/4 px-3 font-medium dark:font-normal border border-red-100 dark:border-red-600/5 text-red-500 dark:text-rose-500 active:text-red-400 dark:active:text-red-700 rounded-sm cursor-pointer select-none"
          >
            Reset Password
          </button>
        </div>
