...
const Stats = ({ total, approved, rejected, pending }) => {
  ...
  const stats = [
    { text: "Total Companies", number: total },
    { text: "Approved", number: approved },
    { text: "Pending", number: pending },
    { text: "Rejected", number: rejected },
  ];
        ...
        {stats.map((stat, i) => {
          return (
            ...
            >
              ...
              <div>
                <p className="text-3xl font-medium mt-1 mb-2">{stat.number}</p>
