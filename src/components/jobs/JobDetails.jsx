...
const JobDetails = ({ job, hasApplied, applicationId }) => {
  ...
  return (
    <div>
      {/* Hero header */}
      <div
        className={`border relative overflow-hidden rounded-xl bg-white dark:bg-foreground/5 px-6 py-6 mb-8`}
      >
      ...
      {/* Quick facts */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-4 mb-8">
        <div
          className={`border rounded-lg bg-white dark:bg-foreground/5 p-4 flex items-center gap-3`}
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 ">
        <div className="lg:col-span-2 space-y-6">
          <section
            className={`border rounded-lg bg-white/80 dark:bg-foreground/5 p-6`}
          >
        ...
        <div className="lg:col-span-1 space-y-6">
          <div
            className={`border rounded-lg bg-white/80 dark:bg-foreground/5 p-5`}
          >
            ...
            {job.company.url && (
              ...
              >
                <button className="w-full rounded-lg border hover:bg-foreground/3 p-1 flex items-center justify-center gap-2 active:scale-95 duration-75 cursor-pointer">
                  Visit Company
          ...
          <div
            className={`${userRole === "recruiter" ? "block" : "hidden"} border space-y-2 rounded-lg bg-white/80 dark:bg-foreground/5 p-6`}
          >
            <h3 className="font-semibold mb-4">Details</h3>
            <div className="text-sm">
              <p className="text-muted">Job ID</p>
              <p className="text-xs break-all">{_id}</p>
            </div>
          </div>
        </div>
      </div>
